...
HEALBOT_BLESSED_RESILIENCE    = GetSpellInfo(33142) or "R�silience b�nie";
...
HEALBOT_EMPOWERED_RENEW       = GetSpellInfo(63534) or "R�novation surpuissante";
...
HEALBOT_MASTER_SHAPESHIFTER   = GetSpellInfo(48412) or "Ma�tre changeforme";
HEALBOT_HEALING_LIGHT         = GetSpellInfo(20237) or "Lumi\195\168re gu\195\169risseuse";
HEALBOT_DIVINITY              = GetSpellInfo(63646) or "Divinit�";
HEALBOT_TOUCHED_BY_THE_LIGHT  = GetSpellInfo(53590) or "Touch� par la Lumi�re";
...
HEALBOT_TIDAL_WAVES           = GetSpellInfo(51562) or "Raz-de-mar�e";
...
HEALBOT_CHAT_NEWVERSION2            = "sur https://discord.gg/addony-dlia-sirus-su-914079030125420565"
