...
if (GetLocale() == "ruRU") then
    ...
    HEALBOT_NEW_ITEMS                      = "Предметы (new)";
    ...
    HB_SPELL_PATTERN_GREATER_HEAL          =
    "Медленно накладываемое заклинание, которое излечивает цель на (%d+)-(%d+) ед. здоровья.";
    ...
    HB_SPELL_PATTERN_REGROWTH              =
    "Исцеляет дружественную цель на (%d+) - (%d+) ед. моментально и еще на (%d+) ед. в течение (%d+) сек";
    ...
    HEALBOT_OPTIONS_RELOADUIMSG            =
    "Для того чтобы настройки вступили бы в силу необходима перезагрузка интерфейса, Готовы?";
